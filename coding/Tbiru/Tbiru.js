...
document.addEventListener("DOMContentLoaded", () => {
  const start = async () => {
    try {
      ...
      const defaultScale = isMobile ? 0.15 : 0.25; // Auto-scale awal ikut peranti

      /* =====================
          BUTTONS (BACK, INFO, SOUND) - Kod asal anda kekal
      ====================== */
      ...
      instructionBox.innerHTML = `
        ...
        <p style="font-size:clamp(14px,3.5vw,18px); line-height:1.4">
          👉 <b>1 Tap</b> : Tukar Paparan <br>
          👉 <b>Drag</b> : Pusing Model <br>
      ...
      const steps = [
        { sceneName: "Jenis Sampah yang sesuai", glb: "/FYPECO/assets/models/Mtongkitar/kertasmain.glb", audio: "/FYPECO/assets/suara/Stongkitar/tbiru1.mp3", scale: defaultScale, info: "Tong biru sesuai untuk sampah jenis kertas.", loaded: false },
        { sceneName: "Bahan boleh dikitar semula", glb: "/FYPECO/assets/models/Mtongkitar/kertas1.glb", audio: "/FYPECO/assets/suara/Stongkitar/tbiru2.mp3", scale: defaultScale, info: "Bahan kertas yang boleh dikitar semula adalah seperti surat khabar, kotak kertas dan sampul surat.", loaded: false },
        { sceneName: "Bahan tak boleh dikitar semula", glb: "/FYPECO/assets/models/Mtongkitar/kertas2.glb", audio: "/FYPECO/assets/suara/Stongkitar/tbiru3.mp3", scale: defaultScale, info: "Bahan kertas yang tak boleh kitar semula adalah seperti cawan kertas, kotak berminyak dan nota lekat.", loaded: false },
      ];
      ...
      function tryTap(x, y) {
        if (!targetFound || moved) return; // Kalau tengah zoom/rotate, jangan tap
      ...
      document.addEventListener("touchmove", e => {
        ...
        if (e.touches.length === 1 && dragging) {
          ...
          moved = true; // Elak tap bertukar bila zoom
      ...
      document.addEventListener("touchend", e => {
        if (!moved) tryTap(e.changedTouches[0].clientX, e.changedTouches[0].clientY);
