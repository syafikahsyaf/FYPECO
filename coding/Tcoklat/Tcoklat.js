...
document.addEventListener("DOMContentLoaded", () => {
     ...
     const steps = [
  {
    ...
    glb: "/FYPECO/assets/models/Mtongkitar/kacamain.glb",
    audio: "/FYPECO/assets/suara/Stongkitar/tcoklat1.mp3",
    scale: 0.2,
    info: "Tong coklat sesuai untuk sampah jenis kaca.",
    loaded: false
  },
  {
    sceneName: "Bahan boleh dikitar semula",
    glb: "/FYPECO/assets/models/Mtongkitar/kaca1.glb",
    audio: "/FYPECO/assets/suara/Stongkitar/tcoklat2.mp3",
    scale: 0.2,
    info: "Bahan kaca yang boleh dikitar semula adalah Balang kaca, botol kaca dan gelas kaca.",
    loaded: false
  },
  {
    sceneName: "Bahan tak boleh dikitar semula",
    glb: "/FYPECO/assets/models/Mtongkitar/kaca2.glb",
    audio: "/FYPECO/assets/suara/Stongkitar/tcoklat3.mp3",
    scale: 0.18,
    info: "Bahan kaca yang tak boleh kitar semula adalah seperti mentol lampu, cermin dan mangkuk seramik.",
    loaded: false
  }
];
