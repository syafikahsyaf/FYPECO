  ...
  const start = async () => {
    try {
      ...
      const mindarThree = new window.MINDAR.IMAGE.MindARThree({
        ...
        imageTargetSrc: "/FYPECO/assets/targets/tongkitar/tongoren.mind"
      });
      ...
      instructionBox.innerHTML = `
        ...
        <p style="font-size:clamp(14px,3.5vw,18px); line-height:1.4">
          ...
          👉 <b>Pinch</b> : Zoom (Guna 2 jari)<br><br>
      ...
      const steps = [
        {
          ...
          glb: "/FYPECO/assets/models/Mtongkitar/plastlogmain.glb",
          audio: "/FYPECO/assets/suara/Stongkitar/tjingga1.mp3",
          scale: 0.2,
          info: "Tong jingga sesuai untuk sampah jenis plastik dan logam.",
          loaded: false
        },
        {
          sceneName: "Bahan boleh dikitar semula",
          glb: "/FYPECO/assets/models/Mtongkitar/Lplas1.glb",
          audio: "/FYPECO/assets/suara/Stongkitar/tjingga2.mp3",
          scale: 0.2,
          info: "Bahan plastik dan logam yang boleh dikitar semula adalah seperti Tapau plastik, botol jus plastik, tin makanan dan tin aerosol kosong.",
          loaded: false
        },
        {
          sceneName: "Bahan tak boleh dikitar semula",
          glb: "/FYPECO/assets/models/Mtongkitar/Lplast2.glb",
          audio: "/FYPECO/assets/suara/Stongkitar/tjingga3.mp3",
          scale: 0.18,
          info: "Bahan plastik dan logam yang tak boleh kitar semula adalah seperti polisterin, paip PVC, tong cat logam dan bateri.",
          loaded: false
        }
      ];
      ...
      function tryTap(x, y) {
        // Jika sedang rotate/zoom (moved=true), jangan tap
        ...
        if (!steps[currentStep].model) return;
